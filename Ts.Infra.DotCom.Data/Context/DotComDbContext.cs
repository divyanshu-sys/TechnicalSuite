...
namespace Ts.Infra.DotCom.Data.Context
{
    public class DotComDbContext : DbContext
    {
        public DotComDbContext(DbContextOptions<DotComDbContext> options) : base(options)
        {
