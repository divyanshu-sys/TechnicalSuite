...
using Ts.Dto;
namespace Ts.DotIn.Service.HttpClientServices.ClientServices
{
    public class FileClient : IFileClient
    {
        ...
        public FileClient(IHttpFileClientService httpFileClientService, IConfiguration configuration)
        {
            ...
            UploadPostImageApiUrl = configuration.GetValue<string>("SrcApiDotIn:UploadPostImageApiUrl");
            DeletePostImageApiUrl = configuration.GetValue<string>("SrcApiDotIn:DeletePostImageApiUrl");

            UploadStoryImageApiUrl = configuration.GetValue<string>("SrcApiDotIn:UploadStoryImageApiUrl");
            DeleteStoryImageApiUrl = configuration.GetValue<string>("SrcApiDotIn:DeleteStoryImageApiUrl");
        }
