...
{
    public class ExchangePolicyFluent
    {
        public ExchangePolicyFluent(EntityTypeBuilder<ExchangePolicy> builder)
        {
            ...
            builder.Property(x => x.ExchangeInDays).IsRequired(true);
